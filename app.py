...
app.config['MAIL_USERNAME'] = 'hoppyhour247@gmail.com'
app.config['MAIL_PASSWORD'] = 'gMyR7CwaXsGFtb0h'
...
def forgot_password():
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            msg = Message('Hello, Here is your reset token', sender='hoppyhour247@gmail.com', recipients=[user.email])
